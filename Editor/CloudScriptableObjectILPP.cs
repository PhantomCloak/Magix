        ...
        private void PassResouceLoadHook(TypeDefinition typeDef, AssemblyDefinition asmDef)
        {
            foreach (var method in typeDef.Methods)
            {
                ...
                for (int i = 0; i < method.Body.Instructions.Count; i++)
                {
                    ...
                    GenericInstanceMethod genericHookMethod;

                    if (operand.Name == "Load")
                    {
                        genericHookMethod = new GenericInstanceMethod(HookDirectLoadFunc);
                    ...
                    {
                        genericHookMethod = new GenericInstanceMethod(HookDirectAllLoadFunc);
